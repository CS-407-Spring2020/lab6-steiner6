...
public class MainActivity extends FragmentActivity {
    ...
    private final LatLng mBascom = new LatLng(43.075234, -89.404158);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(googleMap -> {
            mMap = googleMap;
            googleMap.addMarker(new MarkerOptions().position(mDestinationLatLng).title("Australia"));
            displayMyLocation();
        });
            ...
            mFusedLocationProviderClient.getLastLocation().addOnCompleteListener(this, task -> {
                ...
                if (task.isSuccessful() && mLastKnownLocation != null) {
                    mMap.addPolyline(new PolylineOptions().add(new LatLng(mLastKnownLocation.getLatitude(),
                            mLastKnownLocation.getLongitude()), mBascom));
                    mMap.addPolyline(new PolylineOptions().add(new LatLng(mLastKnownLocation.getLatitude(),
                    ...
                    mMap.addMarker(new MarkerOptions().position(mBascom).title("Bascom"));
